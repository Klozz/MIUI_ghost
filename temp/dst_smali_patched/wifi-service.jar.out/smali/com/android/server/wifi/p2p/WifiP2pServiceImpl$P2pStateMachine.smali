...
.method private clearClientDeadChannels()V
    ...
    const-string v7, "detect dead channel"
...
.method private handleGroupRemoved()V
    ...
    const-string v6, "stop DHCP client"
    ...
    const-string v7, "Failed to remove iface from local network "
...
.method private reinvokePersistentGroup(Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    ...
    const-string v4, "target device reaches group limit."
    ...
    const-string v5, "netId related with "
...
.method private removeClientFromList(ILjava/lang/String;Z)Z
    ...
    const-string v4, "Remove unknown network"
    ...
    const-string v5, "Modified client list: "
