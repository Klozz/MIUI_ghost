...
.field protected static final EVENT_RADIO_UNAVAILABLE:I = 0x9
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v7, "Error! This handler was not registered for this message type. Message: "
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/PhoneProxy;->loge(Ljava/lang/String;)V
    ...
    :cond_0
    const-string v6, "Unexpected exception on EVENT_RIL_CONNECTED"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/PhoneProxy;->logd(Ljava/lang/String;)V
    ...
    const-string v5, "EVENT_VOICE_RADIO_TECH_CHANGED"
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/PhoneProxy;->phoneObjectUpdater(I)V
    ...
    :cond_1
    const-string v5, "EVENT_REQUEST_VOICE_RADIO_TECH_DONE"
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/PhoneProxy;->phoneObjectUpdater(I)V
    ...
    const-string v6, "broadcast_emergency_call_state_changes_bool"
    ...
    const-string v7, "broadcastEmergencyCallStateChanges ="
    ...
    :cond_6
    const-string v6, "didn\'t get broadcastEmergencyCallStateChanges from carrier config"
...
.method public setMaxTransmitPower(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->setMaxTransmitPower(ILandroid/os/Message;)V
