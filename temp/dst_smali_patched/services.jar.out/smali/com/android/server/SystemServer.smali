...
.method private startOtherServices()V
    ...
    const-string v3, "config.disable_bluetooth"
    ...
    const-string v3, "config.disable_location"
    ...
    const-string v3, "config.disable_systemui"
    ...
    const-string v3, "config.disable_noncore"
    ...
    const-string v3, "config.disable_network"
    ...
    const-string v3, "config.disable_atlas"
    ...
    const-string v4, "Scheduling Policy"
    ...
    const-string v4, "Camera Service"
    ...
    const-string v4, "Content Manager"
    ...
    const-string v4, "System Content Providers"
    ...
    const-string v4, "Vibrator Service"
    ...
    const-string v4, "Consumer IR Service"
    ...
    const-string v4, "No Bluetooh Service (emulator)"
    ...
    const-string v4, "Accessibility Manager"
    ...
    const-string v4, "system_init.startmountservice"
    ...
    const-string v4, "Network Score Service"
    ...
    const-string v4, "NetworkStats Service"
    ...
    const-string v4, "NetworkPolicy Service"
    ...
    const-string v4, "com.android.server.wifi.WifiScanningService"
    ...
    const-string v4, "com.android.server.wifi.RttService"
    ...
    const-string v4, "Connectivity Service"
    ...
    const-string v4, "Network Service Discovery Service"
    ...
    const-string v4, "UpdateLock Service"
    ...
    const-string v4, "Country Detector"
    ...
    const-string v4, "Search Service"
    ...
    const-string v4, "DropBox Service"
    ...
    const-string v4, "Wired Accessory Manager"
    ...
    const-string v4, "com.android.server.midi.MidiService$Lifecycle"
    ...
    const-string v4, "com.android.server.usb.UsbService$Lifecycle"
    ...
    const-string v4, "Serial Service"
    ...
    const-string v4, "android.software.voice_recognizers"
    ...
    const-string v4, "Gesture Launcher Service"
    ...
    const-string v4, "DiskStats Service"
    ...
    const-string v4, "SamplingProfiler Service"
    ...
    const-string v4, "CommonTimeManagementService"
    ...
    const-string v4, "com.android.server.print.PrintManagerService"
    ...
    const-string v4, "Media Router Service"
    ...
    const-string v4, "EdgeGesture service"
    ...
    const-string v4, "Failure starting Account Manager"
    ...
    const-string v4, "Bluetooth Service disabled by config"
    ...
    const-string v4, "Bluetooth Service"
    ...
    const-string v4, "com.android.server.MountService$Lifecycle"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    :goto_3c
    const-string v3, "starting Network Score Service"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "starting WiredAccessoryManager"
    ...
    const-string v4, "Assets Atlas Service"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    :goto_46
    const-string v3, "starting AssetAtlasService"
    ...
    const-string v4, "Failure starting Gesture Sensor Service"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    :goto_48
    const-string v3, "starting MediaRouterService"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "starting BackgroundDexOptService"
    ...
    const-string v4, "Failure starting EdgeGesture service"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "making Power Manager Service ready"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "making Display Manager Service ready"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "making EdgeGesture service ready"
    ...
    .restart local v62    # "e":Ljava/lang/Throwable;
    const-string v3, "making Gesture Sensor Service ready"
